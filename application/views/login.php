                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    <div class="text-center">
                                        <img src="<?php base_url() ?>assets/img/suzuya-group.png" class="img-fluid" alt="Responsive image">
                                        <h1 class="h4 text-gray-900 mb-4"></h1>
                                        <?php echo $this->session->flashdata('message') ?>
                                    </div>
                                    <form class="user" method='post' action='<?php echo base_url(); ?>login'>
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="masukkan kode supplier" name='username'>
