        ...
        try {
            ...
            foreach ($resultBttt as $valBtt) {
                ...
                foreach ($resultBtt as $value) {
                    ...
                    if ($cekResult > 0) {
                        foreach ($resultBtt1 as $values) {
                            ...
                            $resultIdemp = $this->db3->query($sql);
                            // var_dump($resultIdemp); die;
                            if ($resultIdemp) {
                                // var_dump($resultIdemp); die;
                                $resultIdemp =  $resultIdemp->result_array();
                ...
                if ($psn) {
                    ...
                    // var_dump($values); die;
                    $sqlIdemp4 = "SELECT * FROM idem_dump WHERE no_bttt = '$values[no_btt]' AND selisih_total_prc >= '0'";
